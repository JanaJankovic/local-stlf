...
def train_model(
    ...
    for epoch in range(num_epochs):
        ...
        log_metrics_per_epoch(
            model, epoch, train_loader, val_loader, device, eval_log_path, scaler
        )
...
if __name__ == "__main__":
    ...
    train_loader, val_loader, test_loader, scaler = prepare_data(
        csv_path, seq_len, horizon, batch_size=batch_size
    )
    ...
    trained_model = train_model(
        model, train_loader, val_loader, scaler, num_epochs=20, patience=20
    )
